<template>
  <div class="add-document-container" v-if="status=='success'">
    ...
    <div>
      <input type="text" class="input text-input" v-model="name" placeholder="Document Name" />
    </div>

    <div>
      <textarea v-model="notes" class="input" placeholder="Notes" rows="10" />
    </div>
